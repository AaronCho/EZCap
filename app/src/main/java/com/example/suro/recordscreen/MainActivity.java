...
public class MainActivity extends AppCompatActivity {
    ...
    TextView textView; //word automatically change colour
    private int clo = 0;//word automatically change colour
    public ImageButton Vedio,Camera,Record,Gallery,Share,Help,Set;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Vedio=(ImageButton)findViewById(R.id.vi_vedio);
